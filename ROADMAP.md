...
| — | Café walls vanished from the garden | The wall-fade "am I inside?" test defaulted to `Grid.PLOT_DEPTH` (max expansion, 128 studs), so the garden counted as indoors |
